...
**tomo** is commad-line-interface for running tomographic scans at beamline `beamline 7bm <https://7bm-docs.readthedocs.io>`_ of the `Advanced Photon Source <https://www.aps.anl.gov/>`_
...
::
    ...
    $ git clone https://github.com/xray-imaging/7bm-tomo.git
    $ cd 7bm-tomo
